            ...
            <div class="container mt-4">
                <form method="POST" action="{{ route('incident.update', $data->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{ $data->incident_date }}" type="datetime-local" class="form-control" name="dateof"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{ $data->incident_name }}" type="text" class="form-control" name="subject"
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{ $data->created_date }}" type="datetime-local" class="form-control" name="datereport"
                            required>
